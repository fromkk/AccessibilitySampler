//
//  SwitchNotAccessibleViewController.swift
...
final class SwitchNotAccessibleViewController: UIViewController {
    enum Section {
        case items
    }
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = L10n.Root.switchNotAccessible
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(
            SwitchNotAccessibleViewCell.self,
            forCellReuseIdentifier: SwitchNotAccessibleViewCell.reusableIdentifier)
        ...
        let dataSource = UITableViewDiffableDataSource<Section, Item>(tableView: tableView) {
            ...
            let cell =
                tableView.dequeueReusableCell(
                    withIdentifier: SwitchNotAccessibleViewCell.reusableIdentifier, for: indexPath)
                as! SwitchNotAccessibleViewCell
